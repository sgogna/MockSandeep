...
public class CompareWithNoBaseTestFailedITCase extends IntegrationCompareTestBase
{
    @Override
    public void test() throws Exception
    {
        ...
        assert !communicationResponse.isCorrect() : "Incorrect response for run CompareWithNoBaseTestFailedITCase";
        ...
        assert !(new File(getBasicTestPath() + File.separator + "ShoppingApi_shop__SABREGDS_SSWIntellisell_1" + "_RS.xml")).exists() : "Files form compare folder was copy to base.";
    }
}
