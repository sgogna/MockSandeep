...
public class EndTestRequestTect1ComparatorITCase extends IntegrationTestBase
{
    @Override
    public void test() throws Exception
    {
        ...
        setAirline("Test");
        setRunId("CompareTect1ComparatorTest");
        ...
        assert communicationResponse.isCorrect() : "Incorrect response for run CompareTect1ComparatorTest";

        assert InfoFileManager.getInfo(getPath(), InfoFileManager.COMPARE_ALGORITHM).equals("Test1") : "Incorrect " + InfoFileManager.COMPARE_ALGORITHM + " in .info file";
